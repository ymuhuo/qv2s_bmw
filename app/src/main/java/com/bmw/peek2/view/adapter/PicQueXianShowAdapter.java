...
public class PicQueXianShowAdapter extends RecyclerView.Adapter<PicQueXianShowAdapter.ViewHolder> {
...
//        mPipeSection = "";
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_pic_quexian_show, null));
    }
