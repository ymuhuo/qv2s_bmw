...
public interface HCNetSDKByJNA extends Library {
    ...
    public static class NET_DVR_FOCUSMODE_CFG extends Structure {
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("dwSize", "byFocusMode"
                    , "byAutoFocusMode", "wMinFocusDistance"
                    , "byZoomSpeedLevel", "byFocusSpeedLevel"
                    , "byOpticalZoom", "byDigtitalZoom"
                    , "fOpticalZoomLevel", "dwFocusPos", "byRes");
        }
    }
    ...
    int NET_DVR_SaveRealData_V30(int lRealHandle, int stremType, String fileName);

    int NET_DVR_StopSaveRealData_V30(int lRealHandle);
